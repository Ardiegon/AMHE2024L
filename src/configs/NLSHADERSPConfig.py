...
class NLSHADERSPConfig:
    ...
    def __init__(self, problem_dimensions=10):
        ...
        self.population_size_min = int(5 * problem_dimensions)
        ...
        # Jeśli iloczyn najmniejsze możliwej liczby populacji będzie mniejszy niż 2 to algorytm może się zaciąć
